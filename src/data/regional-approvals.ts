...
export const regionalApprovals: Record<string, RegionalRow> = {
  ...
  ofatumumab: { EU: A(2010, epar("arzerra")) },
  ...
  "ibritumomab-tiuxetan": { EU: A(2004, epar("zevalin")) },
  aprepitant: { EU: A(2003, epar("emend")) },
  busulfan: { EU: A(2003, epar("busilvex")) },
  pegfilgrastim: { EU: A(2002, epar("neulasta")) },
  temoporfin: { EU: A(2001, epar("foscan")) },
  cytarabine: { EU: A(2001, epar("depocyte")) },
  alemtuzumab: { EU: A(2001, epar("mabcampath")) },
