...
export const ORGAN_SCHEMATICS: OrganSchematic[] = [
  ...
  { id: "haematopoietic", name: "Bone marrow, lymph nodes and spleen", cancers: ["marginal-zone-lymphoma", "cutaneous-t-cell-lymphoma", "primary-mediastinal-b-cell-lymphoma", "leukaemia", "aml", "all-leukemia", "cll", "cml", "dlbcl", "follicular-lymphoma", "hodgkin-lymphoma", "mantle-cell-lymphoma", "multiple-myeloma", "non-hodgkin-lymphoma", "mds", "myeloproliferative-neoplasms", "polycythaemia-vera", "essential-thrombocythaemia", "waldenstrom", "hairy-cell-leukemia", "peripheral-t-cell-lymphoma", "bpdcn", "burkitt-lymphoma", "hiv-associated-lymphoma", "cmml", "systemic-mastocytosis", "histiocytoses", "langerhans-cell-histiocytosis", "post-transplant-lymphoproliferative-disorder"], "post-transplant-lymphoproliferative-disorder", "aml-flt3", "aml-idh", "aml-npm1-kmt2a", "aml-secondary", "apl", "aml-older-unfit", "smouldering-myeloma", "myeloma-transplant-eligible", "myeloma-transplant-ineligible", "myeloma-relapsed-refractory", "plasma-cell-leukaemia", "mds-lower-risk", "mds-higher-risk", "cll-treatment-naive", "cll-relapsed", "richter-transformation-cll", "cml-chronic-phase", "cml-advanced-phase", "primary-myelofibrosis"],
