...
export const thyroidSubtypes: CancerInput[] = [
  { id: "papillary-thyroid-cancer", kind: "cancer", name: "Papillary thyroid cancer", group: "endocrine", parent: "thyroid", asOf, tags, wikipedia: W("Papillary_thyroid_cancer"),
    ...
    pipeline: [], openProblems: ["Overdiagnosis and overtreatment of small tumours found by imaging.", "Which intermediate-risk patients truly benefit from radioactive iodine.", "Resistance to kinase inhibitors in refractory disease."],
  ...
  { id: "follicular-thyroid-cancer", kind: "cancer", name: "Follicular thyroid cancer", group: "endocrine", parent: "thyroid", asOf, tags, wikipedia: W("Follicular_thyroid_cancer"),
    ...
    pipeline: [], openProblems: ["Telling adenoma from carcinoma without surgery.", "Bone metastases respond poorly to iodine.", "Few trials specific to follicular histology."],
  ...
  { id: "medullary-thyroid-cancer", kind: "cancer", name: "Medullary thyroid cancer", group: "endocrine", parent: "thyroid", asOf, tags, wikipedia: W("Medullary_thyroid_cancer"),
    ...
    pipeline: [], openProblems: ["No cure once the disease has spread beyond the neck.", "Resistance mutations to RET inhibitors (G810) are emerging.", "RET-negative sporadic disease has no targeted option."],
  ...
  { id: "anaplastic-thyroid-cancer", kind: "cancer", name: "Anaplastic thyroid cancer", group: "endocrine", parent: "thyroid", asOf, tags, wikipedia: W("Anaplastic_thyroid_cancer"),
    ...
    pipeline: [], openProblems: ["Most patients still die within a year.", "BRAF wild-type disease has no targeted option.", "Trials are tiny because the disease is rare and fast."],
