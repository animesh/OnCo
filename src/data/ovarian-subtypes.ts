...
export const ovarianSubtypes: CancerInput[] = [
  ...
  { id: "low-grade-serous-ovarian-cancer", kind: "cancer", name: "Low-grade serous ovarian cancer", group: "gynaecologic", parent: "ovarian", asOf, tags, wikipedia: W("Ovarian_cancer"),
    ...
    links: [{ label: "Wikipedia", url: W("Ovarian_cancer") }] },
  { id: "clear-cell-ovarian-cancer", kind: "cancer", name: "Clear cell ovarian cancer", group: "gynaecologic", parent: "ovarian", asOf, tags, wikipedia: W("Clear-cell_ovarian_carcinoma"),
  ...
  { id: "mucinous-ovarian-cancer", kind: "cancer", name: "Mucinous ovarian cancer", group: "gynaecologic", parent: "ovarian", asOf, tags, wikipedia: W("Ovarian_cancer"),
    ...
    links: [{ label: "Wikipedia", url: W("Ovarian_cancer") }] },
  { id: "granulosa-cell-tumour", kind: "cancer", name: "Adult granulosa cell tumour of the ovary", group: "gynaecologic", parent: "ovarian", asOf, tags, wikipedia: W("Granulosa_cell_tumour"),
