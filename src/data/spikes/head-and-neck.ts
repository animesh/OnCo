...
const trials: TrialInput[] = [
  t({ id: "keynote-048", name: "KEYNOTE-048", nct: "NCT02358031", phase: "3", status: "positive", yearReported: 2019, sponsor: "Merck", enrolled: 882,
    ...
    drugs: ["pembrolizumab"], targets: ["pd1", "pdl1"], cancers: ["head-and-neck", "oropharyngeal-cancer", "laryngeal-cancer", "oral-cavity-cancer"], terms: ["cps"], trials: ["extreme"],
  ...
  t({ id: "checkmate-141", name: "CheckMate 141", nct: "NCT02105636", phase: "3", status: "positive", yearReported: 2016, sponsor: "BMS", enrolled: 361,
    ...
    drugs: ["nivolumab"], targets: ["pd1"], cancers: ["head-and-neck", "oropharyngeal-cancer", "oral-cavity-cancer"],
...
const drugs: DrugInput[] = [
  ...
  d({ id: "petosemtamab", name: "Petosemtamab", code: "MCLA-158", modality: "Bispecific antibody (EGFR × LGR5)", status: "phase-3",
    ...
    targets: ["egfr", "lgr5"], technologies: ["bispecific-antibody"], companies: ["merus", "genmab"], cancers: ["head-and-neck", "colorectal"], trials: ["liger-hn1", "nct07775287", "nct06496178", "nct07702032", "nct03526835"], drugs: ["pembrolizumab"],
    links: [ct("NCT06525220")] }),
  d({ id: "ficerafusp-alfa", name: "Ficerafusp alfa", code: "BCA101", modality: "Bifunctional antibody (EGFR × TGF-β trap)", status: "phase-3",
    ...
    targets: ["egfr"], technologies: ["bispecific-antibody"], cancers: ["head-and-neck"], trials: ["fortifi-hn01", "nct07807163"], drugs: ["pembrolizumab"],
