...
const drugs: DrugInput[] = [
  d({ id: "zolbetuximab", name: "Zolbetuximab", brand: "Vyloy", code: "IMAB362", modality: "Monoclonal antibody (anti-Claudin 18.2)", status: "approved", wikipedia: W("Zolbetuximab"),
    ...
    targets: ["cldn18-2"], technologies: ["monoclonal-antibody", "companion-diagnostic"], companies: ["astellas"], cancers: ["gastric", "oesophageal-adenocarcinoma"], trials: ["spotlight-glow"], terms: ["adcc"],
  ...
  d({ id: "flot", name: "FLOT (5-FU, leucovorin, oxaliplatin, docetaxel)", modality: "Cytotoxic regimen", status: "standard-of-care", wikipedia: W("FLOT"),
    ...
    technologies: ["cytotoxic-chemotherapy", "platinum"], cancers: ["gastric", "esophageal", "oesophageal-adenocarcinoma"], trials: ["matterhorn"], related: ["folfox"], terms: ["flot-term"], links: [{ label: "Wikipedia", url: W("FLOT") }] }),
];
