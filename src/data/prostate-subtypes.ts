...
export const tldrZh: Record<string, string> = {
  "prostate-low-risk": "低风险前列腺癌是局限于腺体内、分级组1、PSA低于10的疾病。它生长极慢，密切观察是推荐的首选，大多数选择主动监测的男性从未需要治疗。",
  "prostate-intermediate-risk": "中风险前列腺癌为分级组2或3、PSA在10到20之间或肿瘤占据腺体更大范围的疾病。手术或放疗能治愈大多数患者；预后较好的一半有时可以观察，预后较差的一半在放疗时加用几个月的激素治疗。",
  "prostate-high-risk": "高风险前列腺癌为分级组4或5、PSA高于20或肿瘤已长出腺体外的疾病。它仍可治愈，但需要放疗加两到三年的激素治疗，或手术后放疗；在最高风险的男性中，激素治疗加用阿比特龙现已能延长生命。",
  ...
  "prostate-nmcrpc": "非转移性去势抵抗性前列腺癌是指在激素治疗期间PSA持续上升而扫描仍未见病灶。阿帕鲁胺、恩扎卢胺和达罗他胺三种雄激素受体阻断剂各能将转移推迟约两年并延长生命，其中达罗他胺最温和。",
  ...
  "tregzi": "Tregzi（原Orca-T）是一种经过精确分选的供者干细胞移植物，加入调节性T细胞后可保护患者免受慢性移植物抗宿主病。FDA于2026年6月30日批准其用于血液系统恶性肿瘤成人患者的配型供者移植。",
};
