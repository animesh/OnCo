...
export const cancers: CancerInput[] = [
  ...
  c({
    ...
    pipeline: ["glofitamab","epcoritamab","mosunetuzumab","obecabtagene-autoleucel"],
  ...
  c({
    ...
    pipeline: ["dordaviprone","tovorafenib"],
