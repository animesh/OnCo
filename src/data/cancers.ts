...
export const cancers: CancerInput[] = [
  ...
  c({
    id: "gastric", companies: ["neonc-technologies", "askgene-pharma"], trials: ["symbiotic-gi-16", "nct07362186", "nct07385703", "aspen-06", "nct06532006", "nct07673887", "nct06177041", "nct06504732", "nct07103668"], name: "Gastric & gastro-oesophageal junction cancer", group: "gastrointestinal", wikipedia: W("Stomach_cancer"),
  ...
  c({
    id: "hcc", aka: ["Liver Cancer"], companies: ["nanjing-leads-biolabs", "catalym", "bioinvent-international", "ascentawits-pharmaceuticals", "shanghai-abelzeta"], trials: ["nct06109272", "nct05317819", "nct07490262", "nct06844357"], name: "Hepatocellular carcinoma", group: "gastrointestinal", wikipedia: W("Hepatocellular_carcinoma"),
  ...
  c({
    id: "cholangiocarcinoma", aka: ["Bile Duct Cancer"], companies: ["shenzhen-ionova-life-sciences", "hangzhou-hanx-biopharmaceuticals", "tiumbio"], trials: ["nct07229625", "nct05065957", "nct06622057", "nct05987358", "nct04353375", "companion-002", "nct07265674"], name: "Biliary tract cancer (cholangiocarcinoma)", group: "gastrointestinal", wikipedia: W("Cholangiocarcinoma"),
  ...
  // ======================= GU =======================
  c({
    id: "prostate", trials: ["nct06136624", "nct06136650", "nct06952803", "nct06120491", "nct06855277", "nct06780670", "nct07365995", "nct06764485", "mcrpc", "himalayas-1", "nct07311694", "nct07615101", "nct07649122", "nct05381103"], name: "Prostate cancer", group: "genitourinary", wikipedia: W("Prostate_cancer"),
  ...
  c({
    ...
    tags: ["gyn"], people: ["jade-goody"], trials: ["mumbai-via-screening", "nct07418749", "nct05027776"], related: ["induction-chemo-then-crt", "io-plus-crt-cervical", "caution-mis-radical-hysterectomy", "radiation-plus-io", "early-detection-roadmap", "vaginal"], links: [{ label: "Wikipedia", url: W("Cervical_cancer") }], journals: ["international-journal-of-gynecological-cancer", "journal-of-gynecologic-oncology"], companies: ["color-health", "mabwell-shanghai-bioscience", "bio-thera-solutions", "neonc-technologies"], institutions: ["tikur-anbessa-hospital"],
  }),

  // ======================= Skin / CNS / H&N =======================
  c({
    id: "melanoma", keyPapers: ["paper-esteva-skin-cancer-deep-learning-nature-2017"], trials: ["nct06697301", "nct05155254", "nct05732805", "nct05751928", "nct06743126", "nct06624644", "seacraft-2"], name: "Melanoma", group: "skin", wikipedia: W("Melanoma"),
  ...
  c({
    id: "glioblastoma", keyPapers: ["paper-singh-brain-tumour-initiating-cells-nature-2004"], companies: ["philogen-s-p-a", "neonc-technologies", "aveta-biomics", "hangzhou-hanx-biopharmaceuticals"], trials: ["nct04250922", "nct05118776", "nct05303519"], name: "Glioma & glioblastoma", group: "central nervous system", wikipedia: W("Glioblastoma"),
  ...
  c({
    ...
    tags: ["heme"], people: ["hartmut-dohner", "uwe-platzbecker", "pierre-fenaux"], drugs: ["decitabine", "idarubicin", "mitoxantrone", "rasburicase", "histamine-dihydrochloride", "dorocubicel"], trials: ["aaml0531", "nct06387069", "nct05586074", "nct06852222", "nct05429632"], journals: ["blood-cancer-discovery", "blood-cancer-journal", "clinical-lymphoma-myeloma-and-leukemia", "current-hematologic-malignancy-reports", "haematologica", "hematology-oncology-and-stem-cell-therapy", "journal-of-hematology-and-oncology", "leukemia-and-lymphoma", "leukemia-research"],
  }),
  c({
  ...
  c({
    id: "non-hodgkin-lymphoma", name: "Non-Hodgkin lymphoma (all types)", group: "haematologic", wikipedia: W("Non-Hodgkin_lymphoma"),
  ...
  c({
    id: "brain-tumours", name: "Brain and spinal cord tumours (all types)", group: "central nervous system", wikipedia: W("Brain_tumor"),
  ...
  c({
    id: "childhood-cancers", name: "Childhood cancers (all types)", group: "paediatric", wikipedia: W("Childhood_cancer"),
