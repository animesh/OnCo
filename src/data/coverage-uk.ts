...
const list: UkCoverage[] = [
  ...
  cdf("lorlatinib", "lorlatinib", 628, 2020, "ALK-positive NSCLC after alectinib, ceritinib or crizotinib then another TKI", { note: "Untreated ALK-positive advanced NSCLC (CROWN): TA1103 (October 2025), with a commercial arrangement.", smc: "accepted" }),
  ...
  cdf("daratumumab", "daratumumab", 573, 2019, "With bortezomib and dexamethasone for myeloma after 1 prior therapy (CASTOR)", { note: "Monotherapy after 3 lines: TA510 (2018, CDF). D-VTd induction before transplant: TA783 (2022). DVd moved to routine: TA763 (2022). D-Rd for untreated transplant-ineligible myeloma recommended 2023-24. Subcutaneous form used throughout. With bortezomib, lenalidomide and dexamethasone for untreated myeloma when a transplant is unsuitable (CEPHEUS): TA1170 (June 2026).", smc: "accepted" }),
