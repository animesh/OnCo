...
const list: UkCoverage[] = [
  ...
  rec("trifluridine-tipiracil", "trifluridine-tipiracil", 405, 2016, "Metastatic colorectal cancer after standard therapies", { note: "Metastatic gastric or GOJ cancer after 2 or more therapies: TA669 (2021). With bevacizumab for metastatic colorectal cancer after 2 lines of treatment (SUNLIGHT): TA1008 (September 2024), recommended within the licence.", smc: "accepted" }),
  ...
  rec("cabozantinib", "cabozantinib", 463, 2017, "Advanced RCC after VEGF-targeted therapy", { note: "Untreated RCC: TA542 (2018). HCC after sorafenib appraised 2018. With nivolumab for untreated RCC: TA964 (2024). Previously treated differentiated thyroid cancer unsuitable for or refractory to radioactive iodine: TA928 (November 2023), not recommended.", smc: "accepted" }),
  ...
  cdf("daratumumab", "daratumumab", 573, 2019, "With bortezomib and dexamethasone for myeloma after 1 prior therapy (CASTOR)", { note: "Monotherapy after 3 lines: TA510 (2018, CDF). D-VTd induction before transplant: TA783 (2022). DVd moved to routine: TA763 (2022). With lenalidomide and dexamethasone for untreated myeloma when a transplant is unsuitable (MAIA): TA917 (October 2023), recommended within the licence. Subcutaneous form used throughout. With bortezomib, lenalidomide and dexamethasone for untreated myeloma when a transplant is unsuitable (CEPHEUS): TA1170 (June 2026).", smc: "accepted" }),
