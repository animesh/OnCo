...
export const sarcomaLymphomaSubtypes: CancerInput[] = [
  ...
  { id: "liposarcoma", kind: "cancer", trials: ["sarc028"], name: "Liposarcoma", group: "sarcoma", parent: "sarcoma", asOf, tags, wikipedia: W("Liposarcoma"),
  ...
  { id: "marginal-zone-lymphoma", kind: "cancer", trials: ["augment", "zuma-5"], name: "Marginal zone lymphoma", group: "haematologic", parent: "non-hodgkin-lymphoma", asOf, tags, wikipedia: W("Marginal_zone_B-cell_lymphoma"),
