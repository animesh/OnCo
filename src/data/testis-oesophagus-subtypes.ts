...
export const testisOesophagusSubtypes: CancerInput[] = [
  { id: "seminoma", kind: "cancer", name: "Seminoma", group: "genitourinary", parent: "testicular", asOf, tags, wikipedia: W("Seminoma"),
    ...
    pipeline: [], openProblems: ["Predicting which stage I patients will relapse.", "Late effects of platinum and radiotherapy decades on.", "Rare relapses more than five years out."],
  ...
  { id: "non-seminoma", kind: "cancer", name: "Non-seminomatous germ cell tumour", group: "genitourinary", parent: "testicular", asOf, tags, wikipedia: W("Testicular_cancer"),
    ...
    pipeline: [], openProblems: ["Poor-risk disease still kills about half of those affected.", "Whether high-dose chemotherapy is better than conventional salvage (TIGER).", "Cardiovascular disease, hearing loss and neuropathy in long-term survivors."],
  ...
  { id: "oesophageal-squamous-cell-carcinoma", kind: "cancer", name: "Oesophageal squamous cell carcinoma", group: "gastrointestinal", parent: "esophageal", asOf, tags, wikipedia: W("Esophageal_cancer"),
    ...
    pipeline: [], openProblems: ["Whether surgery can be omitted after a complete response to chemoradiation.", "Most cases worldwide present late without access to endoscopy.", "Nutrition, swallowing and quality of life during and after treatment."],
  ...
  { id: "oesophageal-adenocarcinoma", kind: "cancer", name: "Oesophageal and junctional adenocarcinoma", group: "gastrointestinal", parent: "esophageal", asOf, tags, wikipedia: W("Esophageal_cancer"),
    ...
    pipeline: [], openProblems: ["Barrett's surveillance finds few of the cancers that occur.", "Rising incidence with obesity.", "Oesophagectomy remains a major operation with lasting effects on eating."],
    links: [{ label: "Wikipedia", url: W("Esophageal_cancer") }] },
];
