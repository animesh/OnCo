...
const baseDrugs: DrugInput[] = [
  // ======================= ADCs =======================
  {
    id: "sacituzumab-govitecan", regulatoryEvents: [{ date: "2026-06-24", type: "approval", region: "US", note: "FDA approves sacituzumab govitecan-hziy as monotherapy and in combination with pembrolizumab for first-line treatment of triple-negative breast cancer", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-sacituzumab-govitecan-hziy-monotherapy-and-combination-pembrolizumab-first-line" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Sacituzumab%20govitecan" }], name: "Sacituzumab govitecan", brand: "Trodelvy", code: "IMMU-132", modality: "ADC", asOf, status: "approved", wikipedia: W("Sacituzumab_govitecan"),
  ...
  {
    id: "datopotamab-deruxtecan", regulatoryEvents: [{ date: "2026-05-22", type: "approval", region: "US", note: "FDA approves datopotamab deruxtecan-dlnk for unresectable or metastatic triple-negative breast cancer", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-datopotamab-deruxtecan-dlnk-unresectable-or-metastatic-triple-negative-breast-cancer" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Datopotamab%20deruxtecan" }], name: "Datopotamab deruxtecan", brand: "Datroway", code: "Dato-DXd, DS-1062", modality: "ADC", asOf, status: "approved", wikipedia: W("Datopotamab_deruxtecan"),
  ...
  {
    id: "enfortumab-vedotin", regulatoryEvents: [{ date: "2026-07-10", type: "approval", region: "US", note: "FDA approves pembrolizumab or pembrolizumab and berahyaluronidase alfa-pmph each with enfortumab vedotin-ejfv for muscle invasive bladder cancer", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-pembrolizumab-or-pembrolizumab-and-berahyaluronidase-alfa-pmph-each-enfortumab-vedotin" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Enfortumab%20vedotin" }], name: "Enfortumab vedotin", brand: "Padcev", modality: "ADC", asOf, status: "approved", wikipedia: W("Enfortumab_vedotin"),
  ...
  {
    id: "pembrolizumab", regulatoryEvents: [{ date: "2026-06-12", type: "approval", region: "US", note: "FDA approves belzutifan with pembrolizumab for adjuvant treatment of renal cell carcinoma", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-belzutifan-pembrolizumab-adjuvant-treatment-renal-cell-carcinoma" }, { date: "2026-06-24", type: "approval", region: "US", note: "FDA approves sacituzumab govitecan-hziy as monotherapy and in combination with pembrolizumab for first-line treatment of triple-negative breast cancer", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-sacituzumab-govitecan-hziy-monotherapy-and-combination-pembrolizumab-first-line" }, { date: "2026-07-10", type: "approval", region: "US", note: "FDA approves pembrolizumab or pembrolizumab and berahyaluronidase alfa-pmph each with enfortumab vedotin-ejfv for muscle invasive bladder cancer", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-pembrolizumab-or-pembrolizumab-and-berahyaluronidase-alfa-pmph-each-enfortumab-vedotin" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Pembrolizumab" }], name: "Pembrolizumab", brand: "Keytruda / Keytruda Qlex (SC)", modality: "Monoclonal antibody (anti-PD-1)", asOf, status: "approved", wikipedia: W("Pembrolizumab"),
    ...
    cancers: ["tnbc", "nsclc", "melanoma", "head-and-neck", "urothelial", "colorectal", "gastric", "cervical", "hcc", "rcc", "endometrial", "hodgkin-lymphoma", "ovarian", "pancreatic"],
  ...
  {
    id: "nivolumab", regulatoryEvents: [{ date: "2026-08-06", type: "approval", region: "US", note: "FDA grants accelerated approval to vusolimogene oderparepvec-wtpg in combination with nivolumab for melanoma", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-grants-accelerated-approval-vusolimogene-oderparepvec-wtpg-combination-nivolumab-melanoma" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Nivolumab" }], name: "Nivolumab", brand: "Opdivo / Opdivo Qvantig (SC)", modality: "Monoclonal antibody (anti-PD-1)", asOf, status: "approved", wikipedia: W("Nivolumab"),
  ...
  {
    id: "durvalumab", regulatoryEvents: [{ date: "2026-05-28", type: "approval", region: "US", note: "FDA approves durvalumab in combination with Bacillus Calmette-Guerin for high-risk non-muscle invasive bladder cancer", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-durvalumab-combination-bacillus-calmette-guerin-high-risk-non-muscle-invasive-bladder" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Durvalumab" }], name: "Durvalumab", brand: "Imfinzi", modality: "Monoclonal antibody (anti-PD-L1)", asOf, status: "approved", wikipedia: W("Durvalumab"),
  ...
  {
    id: "relatlimab-nivolumab", regulatoryEvents: [{ date: "2026-08-06", type: "approval", region: "US", note: "FDA grants accelerated approval to vusolimogene oderparepvec-wtpg in combination with nivolumab for melanoma", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-grants-accelerated-approval-vusolimogene-oderparepvec-wtpg-combination-nivolumab-melanoma" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Relatlimab" }], name: "Relatlimab + nivolumab", brand: "Opdualag", modality: "Fixed-dose bispecific combination (anti-LAG-3 + anti-PD-1)", asOf, status: "approved", wikipedia: W("Nivolumab/relatlimab"),
  ...
  {
    id: "zanidatamab", regulatoryEvents: [{ date: "2026-08-25", type: "approval", region: "US", note: "FDA approves zanidatamab-hrii and tislelizumab-jsgr for HER2-positive gastric, gastroesophageal junction, or esophageal adenocarcinoma", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-zanidatamab-hrii-and-tislelizumab-jsgr-her2-positive-gastric-gastroesophageal-junction" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Zanidatamab" }], name: "Zanidatamab", brand: "Ziihera", modality: "Biparatopic bispecific antibody (HER2)", asOf, status: "approved", wikipedia: W("Zanidatamab"),
  ...
  // ======================= RADIOPHARMACEUTICALS =======================
  {
    ...
    targets: ["psma"], technologies: ["radioligand-therapy", "psma-pet"], companies: ["novartis"], cancers: ["prostate", "prostate-mcrpc", "prostate-mhspc"], trials: ["vision", "psmafore"], people: ["louise-emmett"],
  },
  {
  ...
  },
  {
    ...
    targets: ["psma"], technologies: ["targeted-alpha-therapy"], companies: ["novartis", "bayer", "fusion-pharma", "astrazeneca"], cancers: ["prostate", "prostate-mcrpc"],
  },
  {
  ...
  },
  {
    ...
    targets: ["kras"], technologies: ["kras-inhibitors"], companies: ["bms"], cancers: ["nsclc", "colorectal", "pancreatic"],
  },
  {
    id: "daraxonrasib", regulatoryEvents: [{ date: "2026-08-26", type: "approval", region: "US", note: "FDA approves daraxonrasib for metastatic pancreatic adenocarcinoma", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-daraxonrasib-metastatic-pancreatic-adenocarcinoma" }], kind: "drug", name: "Daraxonrasib", brand: "Rasonque", code: "RMC-6236", modality: "Small-molecule pan-RAS(ON) inhibitor", asOf, status: "approved",
  ...
  {
    id: "selpercatinib", regulatoryEvents: [{ date: "2026-07-14", type: "approval", region: "US", note: "FDA grants traditional approval to selpercatinib for locally advanced or metastatic RET fusion-positive solid tumors", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-grants-traditional-approval-selpercatinib-locally-advanced-or-metastatic-ret-fusion-positive" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Selpercatinib" }], name: "Selpercatinib", brand: "Retevmo", modality: "Small-molecule kinase inhibitor (RET)", asOf, status: "approved", wikipedia: W("Selpercatinib"),
  ...
  {
    id: "zidesamtinib", regulatoryEvents: [{ date: "2026-07-22", type: "approval", region: "US", note: "FDA approves zidesamtinib for ROS1 -positive non-small cell lung cancer", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-zidesamtinib-ros1-positive-non-small-cell-lung-cancer" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Zidesamtinib" }], name: "Zidesamtinib", brand: "Jideytro", modality: "Small-molecule kinase inhibitor (ROS1)", asOf, status: "approved",
  ...
  },
  {
    ...
    targets: ["parp", "brca"], technologies: ["parp-inhibitor"], companies: ["astrazeneca", "merck"], cancers: ["ovarian", "tnbc", "breast-hr-positive", "prostate", "pancreatic", "high-grade-serous-ovarian-cancer", "prostate-mcrpc"], trials: ["olympia"],
  },
  {
    ...
    targets: ["parp"], technologies: ["parp-inhibitor"], companies: ["gsk"], cancers: ["ovarian", "prostate", "high-grade-serous-ovarian-cancer", "prostate-mcrpc"],
  },
  {
    ...
    targets: ["parp", "brca"], technologies: ["parp-inhibitor"], companies: ["pfizer"], cancers: ["tnbc", "breast-hr-positive", "prostate", "prostate-mcrpc"],
  },
  {
    id: "palbociclib", regulatoryEvents: [{ date: "2026-06-24", type: "approval", region: "US", note: "FDA approves palbociclib with trastuzumab, with or without pertuzumab, and endocrine therapy for the maintenance treatment of HR-positive, HER2-positive metastatic breast cancer", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-palbociclib-trastuzumab-or-without-pertuzumab-and-endocrine-therapy-maintenance" }, { date: "2026-07-14", type: "approval", region: "US", note: "FDA approves gedatolisib with fulvestrant, with or without palbociclib, for HR-positive, HER2-negative locally advanced or metastatic breast cancer", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-gedatolisib-fulvestrant-or-without-palbociclib-hr-positive-her2-negative-locally" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Palbociclib" }], name: "Palbociclib", brand: "Ibrance", modality: "Small-molecule CDK4/6 inhibitor", asOf, status: "approved", wikipedia: W("Palbociclib"),
  ...
  {
    id: "ribociclib", aka: ["Ribociclib Succinate and Letrozole", "Kisqali Femara Co-Pack"], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Ribociclib" }], name: "Ribociclib", brand: "Kisqali", modality: "Small-molecule CDK4/6 inhibitor", asOf, status: "approved", wikipedia: W("Ribociclib"),
  ...
  {
    id: "capivasertib", regulatoryEvents: [{ date: "2026-06-12", type: "approval", region: "US", note: "FDA approves capivasertib with abiraterone and prednisone for PTEN-deficient androgen pathway modulation-naïve or -sensitive prostate cancer", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-capivasertib-abiraterone-and-prednisone-pten-deficient-androgen-pathway-modulation" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Capivasertib" }], name: "Capivasertib", brand: "Truqap", modality: "Small-molecule AKT inhibitor", asOf, status: "approved", wikipedia: W("Capivasertib"),
    ...
    targets: ["akt", "pik3ca"], technologies: ["kinase-inhibitors", "pi3k-akt-mtor-inhibitors"], companies: ["astrazeneca"], cancers: ["breast-hr-positive", "prostate", "prostate-mhspc"],
  },
  {
  ...
  {
    id: "gedatolisib", regulatoryEvents: [{ date: "2026-07-14", type: "approval", region: "US", note: "FDA approves gedatolisib with fulvestrant, with or without palbociclib, for HR-positive, HER2-negative locally advanced or metastatic breast cancer", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-gedatolisib-fulvestrant-or-without-palbociclib-hr-positive-her2-negative-locally" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Gedatolisib" }], name: "Gedatolisib", brand: "Revtorpyk", modality: "Small-molecule pan-PI3K/mTOR inhibitor", asOf, status: "approved",
  ...
  {
    id: "belzutifan", regulatoryEvents: [{ date: "2026-06-12", type: "approval", region: "US", note: "FDA approves belzutifan with pembrolizumab for adjuvant treatment of renal cell carcinoma", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-belzutifan-pembrolizumab-adjuvant-treatment-renal-cell-carcinoma" }], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Belzutifan" }], name: "Belzutifan", brand: "Welireg", modality: "Small-molecule HIF-2α inhibitor", asOf, status: "approved", wikipedia: W("Belzutifan"),
  ...
  {
    id: "trastuzumab", aka: ["Trastuzumab and Hyaluronidase-oysk", "Herceptin Hylecta"], kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Trastuzumab" }], name: "Trastuzumab", brand: "Herceptin (and biosimilars, Phesgo with pertuzumab)", modality: "Monoclonal antibody (anti-HER2)", asOf, status: "approved", wikipedia: W("Trastuzumab"),
  ...
  {
    id: "tregzi", kind: "drug", name: "Allogeneic regulatory T cell immunotherapy with HSPC and T cells-vldq", brand: "Tregzi", code: "Orca-T", aka: ["Orca-T", "Tregzi"], modality: "Precision-sorted allogeneic stem cell graft with regulatory T cells", asOf: "2026-09-17", status: "approved",
    tldr: "Tregzi, formerly Orca-T, is a donor stem cell transplant sorted with high precision and given with regulatory T cells, so that patients with blood cancers keep the graft's anti-cancer effect while being protected from chronic graft-versus-host disease. The FDA approved it on 30 June 2026 for adults having a matched-donor transplant.",
    summary: "Tregzi is an allogeneic graft made by sorting a matched donor's mobilised blood into haematopoietic stem and progenitor cells and regulatory T cells, infusing them first, and giving a measured dose of conventional T cells two days later, so that the regulatory cells are in place before the effector cells arrive. In the phase 3 Precision-T trial, 187 adults with acute leukaemia or myelodysplastic syndrome undergoing myeloablative matched-donor transplantation were randomised to Tregzi with tacrolimus alone or a standard graft with tacrolimus and methotrexate; chronic graft-versus-host disease-free survival was not reached against 7.3 months (hazard ratio 0.26), and moderate to severe chronic graft-versus-host disease at one year fell from 44 percent to 13 percent, with every treated patient achieving neutrophil recovery within 28 days. The FDA approved it on 30 June 2026 for hematopoietic and immunologic reconstitution and to improve chronic graft-versus-host disease-free survival in adults with haematological malignancies having matched-donor transplantation with a myeloablative preparative regimen. The label warns of graft failure, graft-versus-host disease, infusion reactions and secondary malignancies. Whether the approach extends to mismatched and reduced-intensity transplants is being tested.",
    mechanism: "High-precision cell sorting separates the donor graft into stem and progenitor cells, regulatory T cells and conventional T cells; regulatory T cells infused ahead of a controlled conventional T cell dose suppress alloreactivity while preserving graft-versus-leukaemia and immune reconstitution.",
    approvals: [{ region: "US", year: 2026, indication: "Adults with haematological malignancies undergoing matched-donor haematopoietic stem cell transplantation with a myeloablative preparative regimen, for hematopoietic and immunologic reconstitution and to improve chronic graft-versus-host disease-free survival" }],
    regulatoryEvents: [{ date: "2026-06-30", type: "approval", region: "US", note: "FDA approves allogeneic regulatory T cell-based immunotherapy with HSPC and T cells-vldq (Tregzi, Orca Bio) on the Precision-T trial", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-allogeneic-regulatory-t-cell-based-immunotherapy-hspc-and-t-cells-vldq-use-matched" }],
    cancers: ["aml", "all-leukemia", "mds"], companies: ["orca-bio"], sections: ["cell-therapy"], technologies: ["allogeneic-hsct", "allogeneic-cell-therapy"], trials: ["nct05316701"],
