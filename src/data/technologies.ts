...
export const technologies: TechnologyInput[] = [
  ...
  {
    id: "pet", drugs: ["choline-c11"], dependsOn: ["nuclear-medicine-hardware", "pet-tracer-manufacturing"], kind: "technology", name: "PET (positron emission tomography)", sections: ["imaging"], status: "standard-of-care", asOf, since: 1975, wikipedia: W("Positron_emission_tomography"),
  ...
  {
    id: "proton-therapy", dependsOn: ["treatment-planning-systems", "ct", "in-vivo-dosimetry"], related: ["intensity-modulated-proton-therapy", "proton-therapy-systems"], kind: "technology", name: "Proton therapy", sections: ["radiation"], status: "established", asOf, wikipedia: W("Proton_therapy"),
    ...
    companies: ["iba", "mevion", "varian", "hitachi", "sumitomo-heavy-industries", "protom"], links: [{ label: "Wikipedia", url: W("Proton_therapy") }],
  },
  {
    id: "carbon-ion", related: ["carbon-ion-synchrotrons"], companies: ["toshiba-energy-systems", "hitachi"], kind: "technology", name: "Carbon-ion therapy", sections: ["radiation"], status: "established", asOf,
  ...
  // ======================= ADC =======================
  {
    ...
    terms: ["payload", "linker", "dar", "bystander-effect", "ild"], companies: ["celldex", "tubulis", "adcendo", "alentis-therapeutics", "bighat-biosciences", "callio-therapeutics", "cytomx-therapeutics", "dantari", "emergence-therapeutics", "enlaza-therapeutics", "firefly-bio", "ideaya-biosciences", "iksuda-therapeutics", "mablink-bioscience", "myricx-bio", "mythic-therapeutics", "nbe-therapeutics", "orum-therapeutics", "pheon-therapeutics", "profoundbio", "tallac-therapeutics", "valink-therapeutics"], trials: ["aaml0531", "luminosity"], related: ["idea-efflux-agnostic", "idea-neoadjuvant-adc-io"], links: [{ label: "Wikipedia", url: W("Antibody-drug_conjugate") }],
  },
  {
  ...
  {
    id: "dendritic-cell-vaccines", companies: ["argos-therapeutics", "medigene"], dependsOn: ["apheresis-starting-material", "cell-therapy-release-testing"], kind: "technology", name: "Dendritic cell vaccines", sections: ["immunotherapy"], status: "approved", asOf, since: 2010, wikipedia: W("Sipuleucel-T"),
