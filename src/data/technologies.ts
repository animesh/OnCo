...
export const technologies: TechnologyInput[] = [
  ...
  {
    id: "imaging-mass-cytometry", kind: "technology", name: "Imaging mass cytometry", sections: ["diagnostics"], status: "emerging", asOf, wikipedia: W("Imaging_mass_cytometry"),
    ...
    links: [{ label: "Wikipedia", url: W("Imaging_mass_cytometry") }],
  },
  {
  ...
  {
    id: "gene-expression-prognostic-assays", kind: "technology", name: "Gene-expression prognostic assays", sections: ["diagnostics"], status: "approved", asOf, wikipedia: W("Oncotype_DX"),
    ...
    links: [{ label: "Wikipedia", url: W("Oncotype_DX") }],
  },
  {
  ...
  {
    id: "cancer-cell-line-encyclopedias", kind: "technology", name: "Cancer cell line encyclopedias and dependency maps", sections: ["drug-discovery","ai-computation"], status: "established", asOf, wikipedia: W("Cancer_Cell_Line_Encyclopedia"),
    ...
    links: [{ label: "Wikipedia", url: W("Cancer_Cell_Line_Encyclopedia") }],
  },
  {
