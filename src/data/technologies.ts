...
export const technologies: TechnologyInput[] = [
  ...
  {
    id: "pet-ct", companies: ["siemens-healthineers", "ge-healthcare", "philips", "united-imaging", "canon-medical"], kind: "technology", name: "PET/CT", sections: ["imaging"], status: "standard-of-care", asOf, since: 2001, wikipedia: W("PET-CT"),
  ...
  {
    id: "pet-mri", related: ["mri-field-strengths"], companies: ["siemens-healthineers", "ge-healthcare", "united-imaging"], kind: "technology", name: "PET/MRI", sections: ["imaging"], status: "established", asOf, since: 2010, wikipedia: W("PET-MRI"),
  ...
  {
    id: "spect", related: ["radioligand-dosimetry", "spect-ct"], kind: "technology", name: "SPECT & bone scan", sections: ["imaging"], status: "standard-of-care", asOf, wikipedia: W("Single-photon_emission_computed_tomography"),
  ...
  // ======================= RADIATION =======================
  {
    id: "imrt-igrt", related: ["fractionation-repopulation-models", "total-body-irradiation", "tumour-control-probability-models", "c-arm-linac", "ring-gantry-linac", "tomotherapy"], kind: "technology", name: "IMRT / IGRT (modern external beam)", sections: ["radiation"], status: "standard-of-care", asOf,
  ...
  {
    id: "proton-therapy", related: ["intensity-modulated-proton-therapy", "proton-therapy-systems"], kind: "technology", name: "Proton therapy", sections: ["radiation"], status: "established", asOf, wikipedia: W("Proton_therapy"),
